...
public class Core {
    ...
    private static SerialPort initSerialPort(String wantedPortName) throws IOException, InterruptedException, NoSuchPortException {
        ...
        //{
        CommPortIdentifier pid = CommPortIdentifier.getPortIdentifier("/dev/ttyUSB0");
